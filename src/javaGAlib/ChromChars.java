...
public class ChromChars extends Chromosome {
	 ...
	 */
	/*
	 * Varad : The Dimensions are passed as the parameter Thus creates an array
	 * of characters depicting a gene ...
	 * genes[5]=allele;
	 */
	...
	/**
	 * Determines how many genes are in common betwen this Chromosome and the
	 * given Chromosome
	 * 
	 * @param chromosome
	 * @return int
